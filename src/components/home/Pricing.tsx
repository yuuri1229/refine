      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        <Reveal className="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-ink-100">
          <div className="rounded-t-3xl bg-primary-500 px-7 py-5">
            <h3 className="text-lg font-bold text-white">見直しが出来た場合</h3>
          </div>
          <div className="space-y-5 px-7 py-7">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="tnum text-lg font-bold text-ink-900">見直し額×6ヶ月分</span>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <span className="rounded-full bg-primary-50 px-3 py-1 text-xs font-bold text-primary-700">
                支払い方法
              </span>
              <span className="text-lg font-bold text-ink-900">6ヶ月分を6分割払い</span>
            </div>
        ...
        <Reveal delay={120} className="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-ink-100">
          <div className="rounded-t-3xl bg-moss-600 px-7 py-5">
            <h3 className="text-lg font-bold text-white">見直しができなかった場合</h3>
          </div>
          <div className="space-y-5 px-7 py-7">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-lg font-bold text-ink-900">料金はかかりません</span>
            </div>
